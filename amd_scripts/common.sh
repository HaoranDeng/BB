...
export BB_DATACOMP_MAX_FILES="${BB_DATACOMP_MAX_FILES:-56}"
export BB_IMAGE_SIZE="${BB_IMAGE_SIZE:-512}"
export BB_PREPARE_PROCESSES="${BB_PREPARE_PROCESSES:-16}"
export BB_PREPARE_THREADS="${BB_PREPARE_THREADS:-32}"
export BB_PREPARE_FILES_PER_TASK="${BB_PREPARE_FILES_PER_TASK:-1}"
export BB_PREPARE_ARRAY_CONCURRENCY="${BB_PREPARE_ARRAY_CONCURRENCY:-1}"
export BB_MAX_PREPARE_TASKS="${BB_MAX_PREPARE_TASKS:-4096}"
export BB_ENCODE_BATCH_SIZE="${BB_ENCODE_BATCH_SIZE:-32}"
export BB_ENCODE_WORKERS="${BB_ENCODE_WORKERS:-8}"
export BB_ENCODE_GPUS_PER_JOB="${BB_ENCODE_GPUS_PER_JOB:-4}"
...
export BB_ENCODE_ARRAY_CONCURRENCY="${BB_ENCODE_ARRAY_CONCURRENCY:-1}"
export BB_MAX_ENCODE_TASKS="${BB_MAX_ENCODE_TASKS:-512}"

export BB_CPU_PARTITION="${BB_CPU_PARTITION:-mi2101x}"
export BB_GPU_PARTITION="${BB_GPU_PARTITION:-mi2104x}"
export BB_DEVEL_PARTITION="${BB_DEVEL_PARTITION:-mi2101x}"
...
BB_PREPARE_FILES_PER_TASK=$BB_PREPARE_FILES_PER_TASK
BB_PREPARE_ARRAY_CONCURRENCY=$BB_PREPARE_ARRAY_CONCURRENCY
BB_ENCODE_ARRAY_CONCURRENCY=$BB_ENCODE_ARRAY_CONCURRENCY
BB_ENCODE_GPUS_PER_JOB=$BB_ENCODE_GPUS_PER_JOB
